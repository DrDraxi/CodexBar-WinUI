...
### Fixed
- Hover overlay now targets individual provider panels instead of the entire widget

## [v2.1.1] - 2026-02-16

### Fixed
- Widget now auto-positions correctly when running as the only widget
- Periodic position drift detection (500ms) keeps widget aligned with tray area
...
### Added
- Drag-and-drop provider reordering in Settings with grip handles
- Custom provider order persists across sessions and applies to popup and widget

## [v2.0.3] - 2026-02-13

### Fixed
- Each provider now has its own hover highlight and tooltip instead of one big panel
